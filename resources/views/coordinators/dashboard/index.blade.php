...
<head>
    ...
    <title>TrackTern - Dashboard</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="text-white w-64 min-h-screen shadow-lg" style="background-color: #354484;">
            <nav class="mt-8">
                <div class="px-4">
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('coordinators.dashboard') }}" class="flex items-center px-4 py-3 text-white rounded-lg font-semibold" style="background-color: #2a3866;">
        ...
        <div class="flex-1 bg-yellow-50 p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Here's an overview of your TrackTern dashboard</p>
            </div>

            <!-- Dashboard Cards -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Total Interns Card -->
                <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">Total Interns</h3>
                            <p class="text-3xl font-extrabold text-white">24</p>
                            <p class="text-purple-200 text-sm mt-1">Active this semester</p>
                        </div>
                ...
                <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">Pending Requirements & Documents</h3>
                            <p class="text-3xl font-extrabold text-white">12</p>
                            <p class="text-purple-200 text-sm mt-1">Need attention</p>
                        </div>
                        <div class="text-white group-hover:scale-110 transition-transform">
                            <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                ...
                <!-- Tasks Awaiting Approval Card -->
                <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">Tasks Awaiting Approval</h3>
                            <p class="text-3xl font-extrabold text-white">8</p>
                            <p class="text-purple-200 text-sm mt-1">Ready for review</p>
                        </div>
                        <div class="text-white group-hover:scale-110 transition-transform">
                            <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Submissions Awaiting Review Card -->
                <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">Submissions Awaiting Review</h3>
                            <p class="text-3xl font-extrabold text-white">15</p>
                            <p class="text-purple-200 text-sm mt-1">Pending evaluation</p>
                        </div>
                        <div class="text-white group-hover:scale-110 transition-transform">
                            <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">Upcoming Events & Deadlines</h3>
                            <p class="text-3xl font-extrabold text-white">5</p>
                            <p class="text-purple-200 text-sm mt-1">This week</p>
                        </div>
                        <div class="text-white group-hover:scale-110 transition-transform">
                            <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
