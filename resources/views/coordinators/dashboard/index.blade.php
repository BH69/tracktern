    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 bg-yellow-50 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Total Interns Card -->
                <a href="{{ route('coordinators.intern-progress-tracker') }}" class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group block">
                ...
                <a href="{{ route('coordinators.requirements-management') }}" class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-8 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group block">
                    <div class="flex items-center justify-between">
                        <div>
